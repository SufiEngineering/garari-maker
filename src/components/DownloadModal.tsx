...
export default function DownloadModal({
  ...
  return (
    ...
    >
      <div
        className="bg-[var(--c-surface-2)] border border-red-900/50 rounded-2xl shadow-2xl shadow-red-950/40 max-w-md w-full overflow-hidden"
      ...
      >
        ...
        <div className="p-5 sm:p-6 text-center">
          ...
          <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 rounded-full bg-red-600/20 border-2 border-red-500/40 flex items-center justify-center">
            <svg
              className="w-7 h-7 sm:w-8 sm:h-8 text-[var(--c-accent)]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={2.5}
          ...
          <h2 className="text-lg sm:text-xl font-bold text-[var(--c-text)] mb-1">
            {t.dxfDownloaded}
          </h2>
          <p className="text-sm text-[var(--c-text-3)] mb-4 sm:mb-5">
            {t.fileReady}
          </p>

          {/* CTA Card */}
          <div className="bg-[var(--c-surface-3)] border border-[var(--c-border)] rounded-xl p-4 sm:p-5 mb-4 sm:mb-5 text-start">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-sm font-bold text-[var(--c-text)] mb-1">
                  {t.needManufactured}
                </h3>
                <p className="text-xs text-[var(--c-text-3)] leading-relaxed">
                  {t.manufacturingDesc}
                </p>
              </div>
            </div>
            ...
            <div className="mt-3 flex items-center gap-2">
              <label className="text-xs text-[var(--c-text-3)] whitespace-nowrap">
                {t.quantity}:
              </label>
              <input
                type="number"
                ...
                min={1}
                className="flex-1 rounded-md border border-[var(--c-border)] bg-[var(--c-surface-2)] px-3 py-1.5 text-sm text-[var(--c-text)] focus:outline-none focus:ring-2 focus:ring-red-500 w-20"
              />
              <span className="text-xs text-[var(--c-text-muted)]">{t.quantityUnit}</span>
            </div>
            ...
            <div className="mt-3 flex flex-col gap-2">
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg bg-green-600 hover:bg-green-500 text-[var(--c-text)] text-sm font-semibold transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg bg-red-700/30 hover:bg-red-700/50 border border-red-800/50 text-[var(--c-accent-2)] text-sm font-semibold transition-colors"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
          ...
          {/* Footer link */}
          <p className="text-[11px] text-[var(--c-text-muted)] mb-3 sm:mb-4">
            Visit{" "}
            <a
              href="https://sufi.engineering"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[var(--c-accent)] hover:text-[var(--c-accent-2)] underline underline-offset-2"
            >
              {t.visitWebsite}
            </a>
          </p>
          ...
          <button
            onClick={onClose}
            className="w-full py-2.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-sm text-[var(--c-text-3)] hover:text-[var(--c-text)] transition-colors cursor-pointer"
          >
            {t.close}
          </button>
        </div>
